...
public class Shape_010_011_000 extends Shape {

    public Shape_010_011_000(CanvasView view, ShapeType shapeType, int xCell, int yCell, int color) {
    ...
    protected List<CellPoint> getShapeElement(ShapeOrientation orientation){
        ...
        switch (orientation) {
            case O_90:
                return Arrays.asList( new CellPoint(1, 1, color),
